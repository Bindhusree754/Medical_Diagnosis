...
background_image_url="E:/medical_diagnosis/img1.jpeg"
page_bg_img=f"""
<style>
...
models = {
    'diabetes': pickle.load(open("C:/Users/VENUGOPAL/diabetes_model_sav", 'rb')),
    'heart_disease': pickle.load(open("C:/Users/VENUGOPAL/heart_model_sav", 'rb')),
    'parkinsons': pickle.load(open("C:/Users/VENUGOPAL/parkinsons_model_sav", 'rb')),
    'lung_cancer': pickle.load(open("C:/Users/VENUGOPAL/lung_model_sav", 'rb')),
    'thyroid': pickle.load(open("C:/Users/VENUGOPAL/thyroid_model_sav", 'rb'))
}
...
if selected == 'Diabetes Prediction':
    ...
    DiabetesPedigreeFunction = display_input('Diabetes Pedigree Function value', 'Enter diabetes pedigree function', 'DiabetesPedigreeFunction', 'number')
...
if selected == "Parkinsons Prediction":
    ...
    spread2=display_input('spread2','enter spread1 value','spread2','number')
    D2=display_input('D2','enter D2 value','D2','number')
    PPE=display_input('PPE','enter PPE value','PPE','number')



# Parkinson's Disease Prediction Logic
...
if selected == "Hypo-Thyroid Prediction":
    ...
    age = display_input('Age', 'Enter age of the person', 'age', 'number')
    sex = display_input('Sex (1 = Male; 0 = Female)', 'Enter the sex of the person', 'sex', 'number')
